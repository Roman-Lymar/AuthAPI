...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.PATCH,"/api/v1/users/*/change-password").hasAuthority( "client")
                .antMatchers(HttpMethod.PATCH, "/api/v1/users/*/change-login").hasAuthority( "client")
